...
<link rel="stylesheet" type="text/css" media="screen" href="http://ui.clickmedi.co.kr/1016/ui1016.css?191230111815">
...
$(document).ready(function() {
	...
	if('list' != 'view' || 'hidocCntn' == 'babyphotos'){
		$("meta[property='twitter:title']").each(function(index, ele){
			if(index == 0){
				// 트위터 title
				//$("meta[property='twitter:title']").attr("content", "["+'IS NursHos'+"] " + '건강강좌');
				$(this).attr("content", "["+'IS NursHos'+"] " + '건강강좌');
			}
		})
...
<meta property="og:url" content="http://www.kn-hospital.com/hidocCntn/list/13870" />
...
<meta property="og:type" content="article"/>
		...
		<meta name="description" content="건강강좌" />
		<meta property="og:description" content="건강강좌" />
...
$(document).ready(function() {
	...
	if('' != '13870'){
		$("#sub_title").text("건강강좌");
		$("#sub_menu").empty();
		$("#sub_menu").html('<ul class="skin_menu"><li class="on"><a href="/ISNursHos/health/lecture"  ><span>건강강좌</span></a><li><a href="/ISNursHos/health/column"  ><span>건강칼럼</span></a></li></ul>');
		$("#content_location").html('<h1 id="content_title">건강강좌</h1><div id="center_contents" class="tit_location"><a href="/ISNursHos/">HOME</a> &gt; 건강강좌 &gt; 건강강좌');
	}else{
		$("#sub_title").text('');
		$("#sub_menu").empty();
		$("#sub_menu").html('');
...
<!-- new widget -->
<form id="boardView" action="/hidocCntn/list/13870" method="GET"></form>

<form id="boardList" action="/hidocCntn/list/13870" method="POST" enctype="multipart/form-data">
	<input id="menuNbr" name="menuNbr" type="hidden" value="13870"/>
	...
	<div class="column_list">
		...
		<table class="board_list_type5">
			...
			<tbody>
				...
				<tr onclick="javascript:cntnView('15369');" style="cursor: pointer;">
					<td>7752</td>
	   				<td class="subject">집에선 괜찮은데 병원에서만 혈압이 오른다면?</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15368');" style="cursor: pointer;">
					<td>7751</td>
	   				<td class="subject">목을 노리는 검은 그림자, ‘갑상선암’의 원인</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15367');" style="cursor: pointer;">
					<td>7750</td>
	   				<td class="subject">질 좋은 수면은 만병통치약, 수면 부족의 영향</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15366');" style="cursor: pointer;">
					<td>7749</td>
	   				<td class="subject">새 아파트라 더 놀라운 화장실 ‘붉은색 물때’</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15365');" style="cursor: pointer;">
					<td>7748</td>
	   				<td class="subject">해외여행 필수품 ‘라면’ 챙겼다간 벌금형?</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15364');" style="cursor: pointer;">
					<td>7747</td>
	   				<td class="subject">골다공증 환자의 운동법</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15363');" style="cursor: pointer;">
					<td>7746</td>
	   				<td class="subject">당신의 정자는 왜 약해졌을까?</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15362');" style="cursor: pointer;">
					<td>7745</td>
	   				<td class="subject">중년 남성 괴롭히는 거미형 몸매</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15361');" style="cursor: pointer;">
					<td>7744</td>
	   				<td class="subject">한겨울, 얼음 동동 뜬 음료만 고집한다면?</td>
	   				<td>2019-12-24</td>
				</tr>
			
				<tr onclick="javascript:cntnView('15360');" style="cursor: pointer;">
					<td>7743</td>
	   				<td class="subject">나이가 들면 왜 더 추울까?</td>
	   				<td>2019-12-24</td>
				</tr>
