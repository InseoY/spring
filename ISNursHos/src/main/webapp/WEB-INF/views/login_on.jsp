    ...
    <div class="skin_menu_wrap"> 
     ...
     <div class="skin_gnb"> 
      <div class="skin_link2" id="offert_header_login"> 
       <p class="skin_gnb_a" href="/ISNursHos/member/login" target="_self"> <span class="skin_gmbtn">${member.nick}님! 반갑습니다.</span> </p> 
      </div> 
      <div class="skin_link2" id="offert_header_logout"> 
       <p class="skin_gnb_a" href="/ISNursHos/member/loginlogout" target="_self"> <span class="skin_gmbtn">로그아웃</span> </p> 
      </div>     
