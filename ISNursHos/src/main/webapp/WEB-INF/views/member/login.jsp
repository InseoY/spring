 ...
 <li id="content_sns_btn_fb"><a title="페이스북" href="#none"><img alt="페이스북" src="http://static.clickmedi.co.kr/skin/common/images/btn_fb.gif"></a></li> 
				...
				<section class="sub user">
                    ...
                    <div>
                        <article>
                            <nav>
                                <img src="/ISNursHos/img/member_tit_login.jpg" alt="인사말" style="position: absolute;
                                left: 600px;"/>
                                <span style="position: absolute;
                                right: 600px; top: 523px;">HOME > <strong>로그인</strong></span>
                            </nav>
                            <HR class="hrline">
                            ...
                            <div class="content">
                                ...
                                <section class="login">		
                                    <form action="/ISNursHos/member/login" method="post">
                                        <table>
                                            <tr>
                                                <td><img src="/ISNursHos/img/login1.PNG" alt="아이디" /></td>
                                                <td><input type="text" name="uid" required placeholder="아이디 입력" autocomplete="off" /></td>
                                            </tr>
                                            <tr>
                                                <td><img src="/ISNursHos/img/login2.PNG" alt="비밀번호" /></td>
                                    ...
                                    <div class="info">
                                        ...
                                        <div><a href="/ISNursHos/member/terms">회원가입</a></div>
                                    </div>			
                                </section>
                            </div>
