 ...
 <li id="content_sns_btn_fb"><a title="페이스북" href="#none"><img alt="페이스북" src="http://static.clickmedi.co.kr/skin/common/images/btn_fb.gif"></a></li> 
				...
				<section class="sub user">
                    ...
                    <div>
                        <article>
                            <nav>
                                <img src="/ISNursHos/img/member_tit_terms.jpg" alt="인사말" style="position: absolute;
                                left: 588px;
                                top: 438px;
                            "/>
                                <span style="position: absolute;
                                right: 560px;
                                top: 459px;">HOME > <strong>약관동의</strong></span>
                            </nav>
                            ...
                            <div class="content">
                                <div class="terms">
                                    ...
                                    <div>
                                        <a href="/ISNursHos/member/login" class="btnCancel">취소</a>
                                        <a href="/ISNursHos/member/register" class="btnNext">다음</a>
                                    </div>
