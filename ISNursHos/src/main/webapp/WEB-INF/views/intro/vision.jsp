...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#sub_title").text("병원소개");
        $("#sub_menu").empty();
        $("#sub_menu").html('<ul class="skin_menu"><li><a href="/ISNursHos/intro/hello"  ><span>인사말</span></a><li><a href="/ISNursHos/intro/introduction"  ><span>의료진소개</span></a></li><li class="on"><a href="/ISNursHos/intro/vision"  ><span>미션&비전</span></a></li><li><a href="/ISNursHos/intro/facility"  ><span>시설둘러보기</span></a></li><li><a href="/ISNursHos/intro/map"  ><span>찾아오시는길</span></a></li><li><a href="/ISNursHos/intro/duty"  ><span>환자의 권리와 의무</span></a></li></ul>');
        $("#content_location").html('<h1 id="content_title">미션&비전</h1><div id="center_contents" class="tit_location"><a href="/ISNursHos/">HOME</a> &gt; 병원소개 &gt; 미션&비전');
...
<div class="gm-row skin_bn_wrap2" id="row_lknbKEDMEP"> 
 ...
 <li id="content_sns_btn_pr"><a title="프린터" href="#none"><img alt="프린터" src="http://static.clickmedi.co.kr/skin/common/images/btn_print.gif"></a></li> 
				...
				<div id="page_info" class="skin_sub_content">
	            	<p><img class="smartEditorImg" src="http://src.clickmedi.co.kr/421/1016/upload/smartEditor/2018-11-07/fce94539-df66-4c7b-bc28-6e3fcb34f20b.jpg" title="%EB%AF%B8%EC%85%98.jpg"><br style="clear:both;"><img class="smartEditorImg" src="http://src.clickmedi.co.kr/421/1016/upload/smartEditor/2018-11-07/41b89b67-6267-406b-b5c7-a218c077e69e.jpg" title="%EB%B9%84%EC%A0%84.jpg">&nbsp;</p>
				</div>
