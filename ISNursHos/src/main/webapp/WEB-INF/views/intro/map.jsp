...
<link rel="stylesheet" type="text/css" media="screen" href="http://ui.clickmedi.co.kr/1016/ui1016.css?191227035148">
...
$(document).ready(function() {
	...
	if('menu' != 'view' || 'sub' == 'babyphotos'){
		$("meta[property='twitter:title']").each(function(index, ele){
			if(index == 0){
				// 트위터 title
				//$("meta[property='twitter:title']").attr("content", "["+'IS NursHos'+"] " + '찾아오시는길');
				$(this).attr("content", "["+'IS NursHos'+"] " + '찾아오시는길');
			}
		})
...
<meta property="og:url" content="http://www.kn-hospital.com/ISNursHos/intro/map" />
...
<meta property="og:type" content="article"/>
		...
		<meta name="description" content="찾아오시는길" />
		<meta property="og:description" content="찾아오시는길" />
...
$(document).ready(function() {
	...
	$("#sub_title").text("병원소개");
	$("#sub_menu").empty();
	$("#sub_menu").html('<ul class="skin_menu"><li><a href="/ISNursHos/intro/hello"  ><span>인사말</span></a><li><a href="/ISNursHos/intro/introduction"  ><span>의료진소개</span></a></li><li><a href="/ISNursHos/intro/vision"  ><span>미션&비전</span></a></li><li><a href="/ISNursHos/intro/facility"  ><span>시설둘러보기</span></a></li><li class="on"><a href="/ISNursHos/intro/map"  ><span>찾아오시는길</span></a></li><li><a href="/ISNursHos/intro/duty"  ><span>환자의 권리와 의무</span></a></li></ul>');
	$("#content_location").html('<h1 id="content_title">찾아오시는길</h1><div id="center_contents" class="tit_location"><a href="/ISNursHos/">HOME</a> &gt; 병원소개 &gt; 찾아오시는길');
...
<div class="type05_02">
	...
	<div class="sub_box">
		...
		<!-- 컨텐츠 내용 -->
		<div class="map_list" style="text-align: center;" align="center">
			<!-- <img class="smartEditorImg" src="http://src.clickmedi.co.kr/421/1016/upload/smartEditor/2016-10-26/17a63844-6686-4944-97de-e8cab6bb31ab.png" title="%EC%B0%BE%EC%95%84%EC%98%B4.png"><br style="clear:both;"> -->
			<!-- * 카카오맵 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
<div id="daumRoughmapContainer1577430625985" class="root_daum_roughmap root_daum_roughmap_landing"></div>
...
<script charset="UTF-8">
	new daum.roughmap.Lander({
		...
		<h2>교통편안내</h2>
		<div class="skin_type_tbl last">
			<table>
				<caption>연락처리스트입니다..</caption>
				<colgroup>
				<col width="17%">
				<col width="83%">
				</colgroup>
				<tbody>
					<tr>
						...
						<td>OO IC에서 자차 4분 거리</td>
					</tr>
					<tr>
						<th scope="row"><span>-</span></th>
						<td>OO 버스터미널에서 도보 10분 거리</td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td>부산광역시 부산진구 OO OO IS NursHos</td>
					</tr>
					<tr>
