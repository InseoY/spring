...
<link rel="stylesheet" type="text/css" media="screen" href="http://ui.clickmedi.co.kr/1016/ui1016.css?191227113711">
...
<script>
    ...
    <meta property="og:type" content="article"/>
            ...
            <meta name="description" content="의료진소개" />
            <meta property="og:description" content="의료진소개" />
    ...
    <style>
        ...
        $(document).ready(function() {
            ...
            $("#sub_title").text("병원소개");
	        $("#sub_menu").empty();
	        $("#sub_menu").html('<ul class="skin_menu"><li><a href="/ISNursHos/intro/hello"  ><span>인사말</span></a><li class="on"><a href="/ISNursHos/intro/introduction"  ><span>의료진소개</span></a></li><li><a href="/ISNursHos/intro/vision"  ><span>미션&비전</span></a></li><li><a href="/ISNursHos/intro/facility"  ><span>시설둘러보기</span></a></li><li><a href="/ISNursHos/intro/map"  ><span>찾아오시는길</span></a></li><li><a href="/ISNursHos/intro/duty"  ><span>환자의 권리와 의무</span></a></li></ul>');
	        $("#content_location").html('<h1 id="content_title">의료진소개</h1><div id="center_contents" class="tit_location"><a href="/ISNursHos/">HOME</a> &gt; 병원소개 &gt; 의료진소개');
...
<div class="gm-row skin_bn_wrap2" id="row_lknbKEDMEP"> 
 ...
 <li id="content_sns_btn_pr"><a title="프린터" href="#none"><img alt="프린터" src="http://static.clickmedi.co.kr/skin/common/images/btn_print.gif"></a></li> 
				...
				<div id="page_info" class="skin_sub_content">
	            	<br style="clear: both;"><meta name="title" content="">
...
<div id="contentBasicStyles">
    <style>
        .img_box img { width:190px !important}
    </style>
...
<div class="type02_02">
    ...
    <div class="sub_box">
        ...
        <ul class="list_box">
            <li class="sub_list01">
                <div class="img_box"><img class="smartEditorImg" src="/ISNursHos/img/person.png"><br style="clear: both;"></div>
                <div class="txt_box top_padding">
                    <div class="tit_txt">
                        <strong>OOO</strong><span class="sb_tit">원장</span>
                        <div class="bar">&nbsp;</div>
                        <span>정신과</span>
                    </div>
                    <ul class="sub_list02">
                        <li>OO대학교 의과대학 졸업</li>
                        <li>OO병원 인턴 및 정신과 전공의 수료</li>
                        <li>OO대학 OO병원 정신과 전임의</li>
                        <li>OO병원 정신과 진료과장</li>
                        <li>IS NursHos 병원장</li>
                    </ul>
                </div>
            </li>
            <!-- // -->
            ...
            <!-- // -->
            <li class="sub_list01">
                <div class="img_box"><img class="smartEditorImg" src="/ISNursHos/img/person.png"><br style="clear: both;"><br style="clear: both;"></div>
                <div class="txt_box top_padding">
                    <div class="tit_txt">
                        <strong>OOO</strong><span class="sb_tit">원장</span>
                        <div class="bar">&nbsp;</div>
            ...
            <!-- // -->
            <li class="sub_list01">
                <div class="img_box"><img src="/ISNursHos/img/person.png"><p>&nbsp;</p><br style="clear: both;"></div>
                <div class="txt_box top_padding" style="width: 398px; height: 115px;">
                    <div class="tit_txt">
                        <strong>OOO</strong><span class="sb_tit">원장</span>
                        <div class="bar">&nbsp;</div>
                        <span>가정의학과</span>
                    ...
                    <ul class="sub_list02">
                    </ul><p>&nbsp;</p><ul class="sub_list02">
                    <li>OO대학 의학부 졸업&nbsp;</li>
                    <li>OO병원 인턴수료</li>
                    <li>OO병원 가정의학과 전문의</li>
                </ul><p>&nbsp;</p><ul class="sub_list02">
                </ul><p>&nbsp;</p><ul class="sub_list02">
                </ul>
                </div>
            ...
            <li class="sub_list01">
                <div class="img_box"><img src="/ISNursHos/img/person.png"><br style="clear: both;"><br style="clear: both;"></div>
                <div class="txt_box top_padding">
                    <div class="tit_txt">
                        <strong>OOO</strong><span class="sb_tit">원장</span>
                        <div class="bar">&nbsp;</div>
