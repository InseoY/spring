...
<link rel="stylesheet" type="text/css" media="screen" href="http://ui.clickmedi.co.kr/1016/ui1016.css?191227091334">
...
<script>
    $(document).ready(function() {
        ...
        if('menu' != 'view' || 'sub' == 'babyphotos'){
            $("meta[property='twitter:title']").each(function(index, ele){
                if(index == 0){
                    // 트위터 title
                    //$("meta[property='twitter:title']").attr("content", "["+'IS NursHos'+"] " + '인사말');
                    $(this).attr("content", "["+'IS NursHos'+"] " + '인사말');
                }
            })
    ...
    <meta property="og:url" content="http://www.kn-hospital.com/ISNursHos/intro/hello" />
    ...
    <style>
        ...
        $(document).ready(function() {
            ...
            $("#sub_title").text("병원소개");
            $("#sub_menu").empty();
            $("#sub_menu").html('<ul class="skin_menu"><li class="on"><a href="/ISNursHos/intro/hello"  ><span>인사말</span></a><li><a href="/ISNursHos/intro/introduction"  ><span>의료진소개</span></a></li><li><a href="/ISNursHos/intro/vision"  ><span>미션&비전</span></a></li><li><a href="/ISNursHos/intro/facility"  ><span>시설둘러보기</span></a></li><li><a href="/ISNursHos/intro/map"  ><span>찾아오시는길</span></a></li><li><a href="/ISNursHos/intro/duty"  ><span>환자의 권리와 의무</span></a></li></ul>');
            $("#content_location").html('<h1 id="content_title">인사말</h1><div id="center_contents" class="tit_location"><a href="/ISNursHos/">HOME</a> &gt; 병원소개 &gt; 인사말');
...
<div id="clickmedi_sub" class="wrapper skin_sub">
	...
	<div class="skin_web_header">
        ...
        <div class="gm-el-content gm-image" id="ele_utm7pdm1Mg" style="left: 16px; top: 37px; width: 123px; height: 89px; right: auto; bottom: auto; position: absolute; z-index: 1; opacity: 1;">   <a style="cursor: pointer;" href="/ISNursHos/" target="_self"><img
...
<div id="contentBasicStyles">
	...
	<link rel="stylesheet" type="text/css" media="screen" href="http://static.clickmedi.co.kr/skin/common/css/content.css">
...
<div class="type01_03">
	<!-- 컨텐츠 시작 -->
	<div class="sub_box">
			<div class="img_box" style="text-align: center; " align="center">
				<img class="smartEditorImg" src="/ISNursHos/img/person.png" width="327px" height="327px" title="%EA%B9%80%EC%9B%90%EC%8B%9D%20%EC%9B%90%EC%9E%A5%EB%8B%98%20%EC%9D%B8%EC%82%AC%EB%A7%902.jpg"><br style="clear:both;">
			</div>
			
			<div class="txt_box">
				<div class="tit_txt"><div style="text-align: center;" align="center">어르신들의 현재는 물론&nbsp;</div><div style="text-align: center;" align="center">미래의 건강과 행복까지</div><span><div style="text-align: center;" align="center">소중하게 지켜드리겠습니다.</div></span></div>
				
				<div class="con_txt">
					<p>&nbsp;</p><div style="text-align: center;">고령화 시대로 접어들면서 어르신들의 질병, 빈곤, 고독 등이 심각한 사회 문제로 부각되고 있습니다.&nbsp;</div><div style="text-align: center;">특히 치매, 뇌졸중 같은 노인 질환의 증가는 환자와 가족의 삶의 질을 심각하게 저하시키고&nbsp;</div><div style="text-align: center;">지역 사회의 큰 문제로 대두되고 &nbsp;있습니다.</div><div style="text-align: center;">또한 여러 의료장비와 의료시스템을 구축하여 정확하고 신속한 진료를 통하여&nbsp;</div><div style="text-align: center;">보다 완벽한 의료서비스를 제공하기 위해 전력 매진하고 있습니다.</div><div style="text-align: center;"><br></div><div style="text-align: center;">IS NursHos은 어르신들에게 필요한 의료시스템인 아급성 및 만성기 의료와 치매, 뇌졸중 등 노년기</div><div style="text-align: center;">에 흔히 발생하는 질환에 초점을 맞추어 수준 높은 재활과 노인의료 서비스를 제공하기 위해 설립되었습니다.</div><div style="text-align: center;"><br></div><div style="text-align: center;">어르신들의 신체적, 정신적 특성을 고려한 통합적, 포괄적인 진료로 빠른 회복을 도우며, 육체적 질환 뿐 아니라&nbsp;</div><div style="text-align: center;">마음까지 치유하는 따뜻한 의술로 삶의 희망과 기쁨을 전하는 병원이 되겠습니다.</div><div style="text-align: center;"><br></div><div style="text-align: center;">인생을 회복하는 아름다운 이야기가 있는 병원 'IS NursHos'은</div><div style="text-align: center;">당신의 행복한 노후를 위해 언제나 함께 하겠습니다.</div><p style="text-align: center; ">감사합니다.</p><p>&nbsp;</p></div>
				<div class="signature" align="center" style="text-align: center; ">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; IS NursHos 병원장<strong><br style="clear:both;"></strong>
				</div>
			</div>
	</div>
	<!-- //컨텐츠 끝-->
	...
	<!-- 확대/축소 버튼
	<div class="pm_btn">
		<a href="#"><img src="http://static.clickmedi.co.kr/skin/common/images/btn_large.png" alt="텍스트 크게 보기" /></a>
		<a href="#"><img src="http://static.clickmedi.co.kr/skin/common/images/btn_small.png" alt="텍스트 작게 보기" /></a>
	</div>
	//확대/축소 버튼 -->
	...
	<!-- sns 버튼
	<div class="sns_btn">
		<a href="#"><img src="http://static.clickmedi.co.kr/skin/common/images/sub_sns_btn01.png" alt="트위터" /></a>
		<a href="#"><img src="http://static.clickmedi.co.kr/skin/common/images/sub_sns_btn02.png" alt="페이스북" /></a>
		<a href="#"><img src="http://static.clickmedi.co.kr/skin/common/images/sub_sns_btn03.png" alt="" /></a>
	</div>
	 //sns 버튼 -->
