...
<link rel="stylesheet" type="text/css" media="screen" href="http://ui.clickmedi.co.kr/1016/ui1016.css?191230110032">
...
$(document).ready(function() {
	...
	if('menu' != 'view' || 'sub' == 'babyphotos'){
		$("meta[property='twitter:title']").each(function(index, ele){
			if(index == 0){
				// 트위터 title
				//$("meta[property='twitter:title']").attr("content", "["+'IS NursHos'+"] " + '한방과');
				$(this).attr("content", "["+'IS NursHos'+"] " + '한방과');
			}
		})
...
<meta property="og:url" content="http://www.kn-hospital.com/ISNursHos/medical/orientalmedi" />
...
<meta property="og:type" content="article"/>
		...
		<meta name="description" content="한방과" />
		<meta property="og:description" content="한방과" />
...
$(document).ready(function() {
	...
	$("#sub_title").text("진료안내");
	$("#sub_menu").empty();
	$("#sub_menu").html('<ul class="skin_menu"><li><a href="/ISNursHos/medical/intermedi"  ><span>내과</span></a><li><a href="/ISNursHos/medical/neurology"  ><span>신경과</span></a></li><li><a href="/ISNursHos/medical/psychiatry"  ><span>정신건강의학과</span></a></li><li><a href="/ISNursHos/medical/orthopedics"  ><span>정형외과</span></a></li><li class="on"><a href="/ISNursHos/medical/orientalmedi"  ><span>한방과</span></a></li></ul>');
	$("#content_location").html('<h1 id="content_title">한방과</h1><div id="center_contents" class="tit_location"><a href="/ISNursHos/">HOME</a> &gt; 진료안내 &gt; 한방과');
...
<article class="cms_v1 sub_contents">
	...
	<div id="skin_wrap" class="green"> <!-- 스킨 변경 (class 변경) -->
        ...
        <section class="point_content_img">
            <p class="resize_img"><img src="http://src.clickmedi.co.kr/cms/module/782_3778_img01.jpg" alt="통증조절 및 개선 약침요법 "></p>
        </section>

		<section class="txt_contents bf_mg">
			<div class="big_point_txt">목 또한 일상생활에서 오랫동안 고개를 숙여 공부하는 자세, 엎드려 잠을 자는 자세, 너무 높은 베개를 베고 잠을 자는 자세 등 목에 무리를 가하는 동작이 지속될 경우 추간판 탈출증이 발생할 수 있습니다.</div>
			<p>증상이 가벼운 경우에는 자세를 교정하면 호전될 수 있으나 만성적으로 진행되어 통증이 심해지고 자세가 고정되었다면 치료가 필요합니다. 또한, 퇴행성 관절염은 60세 이상 노인들이 많이 앓고 있는 만성 질환으로 유병률 1위를 차지하고 있습니다. 관절염은 관절에 있는 연골(물렁뼈)이 손상, 퇴화되어 닳아서 생기는 질환으로 오랜 시간에 걸쳐 서서히 진행되며 악화되면 심각한 장애를 초래하는 질환으로 통증을 완화하고 증상을 호전시키는 것이 중요합니다.</p>
		</section>

		<section class="txt_contents">
			<h4>봉침요법</h4>
			<p>벌의 독주머니에 있는 봉독을 별도로 채취하고 가공하여 인체에 해가 없는 성분으로 정제한 후 주사제로 주입하는 봉침요법은 관절에 발생한 염증을 효과적으로 제거하기 위해 강력한 소염작용뿐만 아니라 지속적인 통증을 개선해주는 진통작용까지 가지고 있는 치료방법입니다. <br>벌에서 추출한 벌침을 증류하여 만든 봉침을 그 부위에 주사하여 직접적인 자극으로 뭉쳐있는 어혈을 풀어주어 기혈순환을 도와주며, 효과적으로 통증을 조절하고 증상을 개선할 수 있습니다.</p>
		</section>
	</div>
	<!-- // CMS Skin Contents [e] -->
</article>
